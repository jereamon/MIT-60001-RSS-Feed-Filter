...
class ProblemSet5(unittest.TestCase):
    ...
    def test5AndTrigger(self):
        ...
        self.assertTrue(yy.evaluate(b), "AND of 'always true' and 'always"
                        "true'should be true")
        self.assertFalse(yn.evaluate(b), "AND of 'always true' and 'alwaysz"
                         "false' should be false")
        self.assertFalse(ny.evaluate(b), "AND of 'always false' and 'always"
                         "true' should be false")
        self.assertFalse(nn.evaluate(b), "AND of 'always false' and 'always"
                         "false' should be false")
